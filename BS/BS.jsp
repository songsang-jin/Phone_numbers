...
<div class="container">
			...
			<tbody>
				...
				try {
					...
					pstmt = conn.prepareStatement("select * from phone.bs_num");
		...
		--%>
		<button onclick="location='bs_insert.jsp'" class="btn"  style="float:right">
			추가
		</button>
		<button onclick="location='bs_delete.jsp'" class="btn"  style="float:right">
			삭제
		</button>
