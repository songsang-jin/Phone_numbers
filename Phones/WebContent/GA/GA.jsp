...
<div class="container">
			...
			<tbody>
				...
				try {
					...
					pstmt = conn.prepareStatement("select * from phone.ga_num");
		...
		--%>
		<button onclick="location='ga_insert.jsp'" class="btn"  style="float:right">
			추가
		</button>
		<button onclick="location='ga_delete.jsp'" class="btn"  style="float:right">
			삭제
		</button>
