...
<div class="container">
			...
			<tbody>
				...
				try {
					...
					pstmt = conn.prepareStatement("select * from phone.gr_num");
		...
		--%>
		<button onclick="location='gr_insert.jsp'" class="btn"  style="float:right">
			추가
		</button>
		<button onclick="location='gr_delete.jsp'" class="btn"  style="float:right">
			삭제
		</button>
