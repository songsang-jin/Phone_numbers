...
<div class="container">
			...
			<tbody>
				...
				try {
					...
					pstmt = conn.prepareStatement("select * from phone.js_num");
		...
		--%>
		<button onclick="location='jam_insert.jsp'" class="btn"  style="float:right">
			추가
		</button>
		<button onclick="location='jam_delete.jsp'" class="btn"  style="float:right">
			삭제
		</button>
