...
<div class="container">
			...
			<tbody>
				...
				try {
					...
					pstmt = conn.prepareStatement("select * from phone.jr_num");
		...
		--%>
		<button onclick="location='jr_insert.jsp'" class="btn"  style="float:right">
			추가
		</button>
		<button onclick="location='jr_delete.jsp'" class="btn"  style="float:right">
			삭제
		</button>
