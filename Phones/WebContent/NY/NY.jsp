...
<div class="container">
			...
			<tbody>
				...
				try {
					...
					pstmt = conn.prepareStatement("select * from phone.ny_num");
		...
		--%>
		<button onclick="location='ny_insert.jsp'" class="btn"  style="float:right">
			추가
		</button>
		<button onclick="location='ny_delete.jsp'" class="btn"  style="float:right">
			삭제
		</button>
