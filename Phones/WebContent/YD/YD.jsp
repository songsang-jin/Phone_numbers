...
<nav class="navbar navbar-default">
  ...
  <div class="collapse navbar-collapse" id="#bs-example-navbar-collapse-1">
   ...
   <ul class="nav navbar-nav">
    ...
    <li><a href="../CRM/CRM.jsp">관악CRM</a></li>
    <li><a href="../GA/GA.jsp">관악금융</a></li>
    <li><a href="../NY/NY.jsp">남영</a></li>
    <li><a href="YD.jsp">여의도</a></li>
...
<div class="container">
			...
			<tbody>
				...
				try {
					...
					pstmt = conn.prepareStatement("select * from phone.yd_num");
		...
		--%>
		<button onclick="location='yd_insert.jsp'" class="btn btn-outline-primary " >
			추가
		</button>
		<button onclick="location='yd_delete.jsp'" class="btn btn-outline-primary"  >
			삭제
		</button>
