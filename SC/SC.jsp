...
<div class="container">
			...
			<tbody>
				...
				try {
					...
					pstmt = conn.prepareStatement("select * from phone.sc_num");
		...
		--%>
		<button onclick="location='sc_insert.jsp'" class="btn"  style="float:right">
			추가
		</button>
		<button onclick="location='sc_delete.jsp'" class="btn"  style="float:right">
			삭제
		</button>
